	...
	<div class="e-98">
        ...
        if (isset($_COOKIE['location'])) {
           // $loc = json_decode($_COOKIE['location'],true);
            $result = trim($_COOKIE['location']);//$loc['v'];
        } else {
        ...
        if($ip_data && $ip_data->geoplugin_countryName != null)
        {
            ...
            foreach ($city as $k=>$v) {
                $city_list .= '<div class="e-109" onclick="return page.citySelect(this);" data-id="'.$v.'">'.$v.'</div>';
            }
            $city_list = '<div class="e-110" id="main-city-list" '.($lang_stat?'style="display: none !important;"':'').'><div class="e-40" style="left: 95px;"></div><div class="e-111">'.$city_list.'</div></div><div id="second-city-list" class="e-110" '.($lang_stat?'style="display: block !important;"':'style="display: none !important;"').'><div class="e-112"><div class="e-40" style="left: 95px;"></div><div class="e-113">Ваш город: <span style="color: rgb(0, 124, 185);font-weight: bold;">'.$result.'</span></div><div class="e-114" ><div class="e-115" onclick="return page.citySel(this);" data-id="0">Нет</div><div class="e-116" onclick="return page.citySel(this);" data-id="1" data-city="'.$result.'">Да</div></div></div></div>';
